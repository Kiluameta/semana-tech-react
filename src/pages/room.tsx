...
export function Room() {
    ...
    return (
        <div className="mx-auto max-w-[640px] flex flex-col gap-6 px-4 py-10">
            <div className="flex item-center px-3 gap-3">
                <img src={amaLogo} className='h-5 self-center' alt="AMA" />
                <span className='text-zinc-500 text-sm truncate  self-center'>
